...
public class NBasicTextViewFactory extends PlatformViewFactory {
    private static final String PLUGIN_KEY = "NBasicTextView";
    private static final String VIEW_TYPE_ID = "com.ace.ace_demo01/basic_text_view";
    ...
    public static void registerWith(PluginRegistry registry) {
        ...
        registrar.platformViewRegistry().registerViewFactory(VIEW_TYPE_ID, new NBasicTextViewFactory(registrar.messenger()));
    }
}
